...
const CustomSelect = styled(Select)({
    marginLeft: "2px", width: "270px", '& .MuiOutlinedInput-notchedOutline': {
        borderRadius: '10px',
        height: "50px",
    }, '& .MuiInputLabel-root': {
        fontSize: '14px',
...
export default function FormFillUp() {
    ...
    return (
        ...
        <>
            <Stack direction="column" gap={1} padding={1} sx={{}}>
                <CustomTextField
                    {...register("name")}
                    error={!!errors.name}
                ...
                <Box sx={{ display: "flex", gap: "15px" }}>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <CustomAutoComplete
                                sx={{ width: "273px", marginRight: "-17px" }}
                                {...field}
                                disablePortal
                                options={["type1", "type2", ""]}
                                renderInput={(params) => (
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Autocomplete
                            ...
                            sx={{
                                width: "562px", marginLeft: "2px", '& .MuiOutlinedInput-notchedOutline': {
                                    borderRadius: '10px',
                                    height: "50px",
                                },
                                marginTop: "49px",
                ...
                <Box sx={{ display: "flex", gap: "15px" }}>
                    <Autocomplete
                        ...
                        options={["Ten", "Twenty"]}
                        sx={{
                            width: "287px", height: "8px", marginLeft: "2px", '& .MuiOutlinedInput-notchedOutline': {
                                borderRadius: '10px',
                                height: "50px",
                            },
                            '& .MuiInputLabel-root': {
                    ...
                    <Autocomplete
                        ...
                        options={["A", "B", "C"]}
                        sx={{
                            width: "273px", height: "8px", marginRight: "-17px", marginLeft: "", '& .MuiOutlinedInput-notchedOutline': {
                                borderRadius: '10px',
                                height: "50px"
                            },
                            '& .MuiInputLabel-root': {
                ...
                <Box sx={{ marginLeft: "-18px" }}>
                    <Typography className={styles.benificier} variant="h6" color="#424242" sx={{ marginLeft: "24px", marginTop: "49px", marginBottom: "6px" }}>Benificiaries and Scope</Typography>
                    <Autocomplete
                        multiple
                        disablePortal
                    ...
                    <Box sx={{ display: "flex" }}>
                        <Autocomplete
                            ...
                            options={["Ten", "Twenty", "Thirty"]}
                            sx={{
                                width: "273px", height: "8px", marginLeft: "24px", '& .MuiOutlinedInput-notchedOutline': {
                                    borderRadius: '10px',
                                    height: "50px",
                                },
                                '& .MuiInputLabel-root': {
                        ...
                        <Autocomplete
                            ...
                            options={["Yes", "No"]}
                            sx={{
                                width: "273px", height: "8px", marginLeft: "24px", marginRight: "-21px", '& .MuiOutlinedInput-notchedOutline': {
                                    borderRadius: '10px',
                                    height: "50px"
                                },
                                '& .MuiInputLabel-root': {
                ...
                <Box sx={{ marginLeft: "8px"}}>
                    <Typography className={styles.benificier} variant="h6" color=" #424242" sx={{ marginLeft: "5px", marginTop: "49px" ,marginBottom:"8px"}}>Impact and Feasibilty</Typography>
                    <Box sx={{ display: "flex",marginLeft:"2px"}}>

                        <FormControl fullWidth className={styles.userImpactFormControl}>
                            <InputLabel id="demo-simple-select-label" sx={{ pading: "15px", marginLeft: "30px", fontSize: "14px", marginTop: "-5px", color: "#9E9E9E" }}>User impact</InputLabel>
                ...
                <Typography className={styles.benificier} variant="h6" color=" #424242" sx={{ marginLeft: "20px", marginTop: "-5px", color: "#9E9E9E" }}>Timeline</Typography>
                <DateComponent />
