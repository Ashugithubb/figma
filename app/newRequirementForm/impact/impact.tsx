    ...
    return (
        <>
            ...
            <Box sx={{ display: "flex", width: "100%",gap:"16px" }}>
                <Box sx={{ flex: 1 }}>
                    <CustomSelect labelValue={"User impact"} /></Box>
                <Box sx={{ flex: 1 }}>  <DisableAutoComplte labelValue={"impact"} /></Box>
            </Box>

            <Box sx={{ display: "flex", width: "100%",gap:"16px" }}>
                <Box sx={{ flex: 1 }}> <CustomSelect labelValue={"Complexity and effort"} /></Box>
                <Box sx={{ flex: 1 }}>   <DisableAutoComplte labelValue={"Client priority"} /></Box>
            </Box>
            <Box sx={{ width:"49%"}}><CustomSelect labelValue={"Status"}/></Box> 
</Box>
